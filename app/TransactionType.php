...
class TransactionType extends Model
{
    ...
    public function scopeFilterByRequest($query, Request $request)
    {
        ...
        if ($request->has('transaction_type_group_id')) {
            ...
            } elseif ($request->input('transaction_type_group_id') == config('constants.ConstTransactionTypeGroups.CashWithdrawal')) {
                $query->where('transaction_type_group_id', '=', config('constants.ConstTransactionTypeGroups.CashWithdrawal'));
            } elseif ($request->input('transaction_type_group_id') == config('constants.ConstTransactionTypeGroups.Renting')) {
