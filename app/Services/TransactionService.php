...
class TransactionService
{
     ...
     * @return string
     */
    public function transactionDescription($transactions)
    {
        if (! empty($transactions)) {
            try {
                foreach ($transactions as $transaction) {
                    if (in_array($transaction->transaction_type_id, [config('constants.ConstTransactionTypes.AddedToWallet'), config('constants.ConstTransactionTypes.AdminDeductFundFromWallet')])) {
    ...
    {
        $transaction_type_ids = [config('constants.ConstTransactionTypes.AdminCommission'), config('constants.ConstTransactionTypes.VehicleListingFee')];
