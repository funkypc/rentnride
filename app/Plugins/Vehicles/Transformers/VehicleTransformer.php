...
class VehicleTransformer extends Fractal\TransformerAbstract
{
    ...
    public function transform(Vehicle $vehicle)
    {
        ...
        $output['vehicle_company_id'] = (int) $output['vehicle_company_id'];
        $output['vehicle_make_id'] = (int) $output['vehicle_make_id'];
        $output['vehicle_model_id'] = (int) $output['vehicle_model_id'];
        $output['vehicle_type_id'] = (int) $output['vehicle_type_id'];
        $output['fuel_type_id'] = (int) $output['fuel_type_id'];
        ...
        if (! is_null($vehicle->max_discount_percent)) {
            $output['max_discount_percent'] = (int) $vehicle->max_discount_percent;
        }
        if (! is_null($vehicle->price_details)) {
            $output['price_details'] = $vehicle->price_details;
        }
        $pick_up_location = $drop_up_location = [];
        ...
        $output['per_day_amount'] = (float) $output['per_day_amount'];
        $output['per_hour_amount'] = (float) $output['per_hour_amount'];
