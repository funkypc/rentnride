 ...
 */
class VehicleTypeTransformer extends Fractal\TransformerAbstract
{
    /**
    ...
    protected $availableIncludes = [
        'VehicleTypePrice', 'VehicleSpecialPrice', 'VehicleTypeExtraAccessory', 'VehicleTypeFuelOption', 'VehicleTypeInsurance', 'VehicleTypeSurcharge', 'VehicleTypeTax',
    ];
    ...
    {
        $output = array_only($vehicle_type->toArray(), ['id', 'name', 'minimum_hour_price', 'maximum_hour_price', 'minimum_day_price', 'maximum_day_price', 'drop_location_differ_unit_price', 'drop_location_differ_additional_fee', 'deposit_amount', 'vehicle_count']);
     ...
     */
    public function includeVehicleTypePrice(VehicleType $vehicle_type)
    {
        if ($vehicle_type->vehicle_type_price) {
            return $this->collection($vehicle_type->vehicle_type_price, new VehicleTypePriceTransformer());
        } else {
            return null;
        }
    }
     ...
     * @return Fractal\Resource\Item|null
     */
    public function includeVehicleSpecialPrice(VehicleType $vehicle_type)
    {
        if ($vehicle_type->vehicle_special_price) {
            return $this->collection($vehicle_type->vehicle_special_price, new VehicleSpecialPriceTransformer());
        } else {
            return null;
        }
    }
