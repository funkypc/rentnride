...
class VehiclesController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $enabled_includes = ['vehicle_type', 'fuel_type', 'counter_location', 'vehicle_company', 'vehicle_make', 'vehicle_model', 'attachments', 'user'];
    ...
    public function index(Request $request)
    {
        ...
        $enabled_includes = ['vehicle_type', 'fuel_type', 'counter_location', 'vehicle_company', 'vehicle_make', 'vehicle_model', 'attachments'];
    ...
    {
        $enabled_includes = ['counter_location', 'vehicle_make', 'vehicle_model', 'vehicle_type', 'vehicle_company', 'fuel_type', 'attachments', 'user'];
        $vehicle = Vehicle::with($enabled_includes)->find($id);
        if (! $vehicle) {
            return $this->response->errorNotFound('Invalid Request');
        }
