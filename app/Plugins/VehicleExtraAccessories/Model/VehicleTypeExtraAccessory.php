...
class VehicleTypeExtraAccessory extends Model
{
     ...
     */
    public function vehicle_extra_accessory()
    {
        return $this->belongsTo(VehicleExtraAccessory::class, 'extra_accessory_id');
    }
    ...
    public function scopeGetValidationRule()
    {
        return [
            ...
            'extra_accessory_id' => 'required|integer|exists:extra_accessories,id',
    ...
    public function scopeGetValidationMessage()
    {
        return [
            ...
            'extra_accessory_id.required' => 'Required',
            'extra_accessory_id.integer' => 'Extra Accessories Id must be integer',
            'extra_accessory_id.exists' => 'Invalid extra accessory id',
