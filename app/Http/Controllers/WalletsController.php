            ...
            if ($validator->passes()) {
                try {
                    ...
                    if ($wallet) {
                        ...
                        } elseif ($request->gateway_id == config('constants.ConstPaymentGateways.PayPal')) {
                    ...
                    throw new \Dingo\Api\Exception\StoreResourceFailedException('Wallet could not be updated. Please, try again.', [$e->getMessage()]);
                }
            } else {
                throw new \Dingo\Api\Exception\StoreResourceFailedException('Wallet could not be updated. Please, try again.', $validator->errors());
            }
