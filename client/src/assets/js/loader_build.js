...
(function ($, window, document, undefined) {
    ...
    libraries.push('vendor/angular/angular.min.js');
    libraries.push('vendor/angular-moment/angular-moment.min.js');
    ...
    libraries.push('vendor/angular-translate-storage-cookie/angular-translate-storage-cookie.min.js');
    libraries.push('vendor/angular-translate-handler-log/angular-translate-handler-log.min.js');
    libraries.push('vendor/angular-translate-storage-local/angular-translate-storage-local.min.js');
    libraries.push('vendor/angular-cookies/angular-cookies.min.js');
    ...
    libraries.push('vendor/accounting/accounting.min.js');
    libraries.push('vendor/angularjs-slider/dist/rzslider.min.js');
    ...
    libraries.push('vendor/angularjs-socialshare/dist/angular-socialshare.min.js');
